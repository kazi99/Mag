...
It is beneficial to introduce the Néron-Severi group analog for the Mukai lattice. We call it the \emph{extended Néron-Severi group} and it is defined to be 
\[
...
% \info{Huybrechts restricts himself to schemes of finite type. But Huybrechts, Lehn do not.}
...
% We touch upon this approach in some more detail after the proof of Proposition \ref{Hodge isometry implies D equivalence}. 
...
\begin{theorem}[Derived Torelli theorem, \cite{Orlov2003,Mukai1987}]
