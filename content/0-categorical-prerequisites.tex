...
\begin{example}
    The entirety of subsection \ref{} and first section of chapter \ref{} will be devoted to a constructing a substantial amount of triangulated categories and triangulated functors.    
\end{example}
