...
\]
which we will be denoting by the matrix
\begin{equation}
...
The following are all specialized results characterizing, when a triangulated functor is an equivalence. We will use \ref{} in the proof of proposition \ref{}. We will exploit corollary \ref{condition for functor to be an equivalence} and proposition \ref{Serre functors and adjoints} in the proof of the Derived Torelli theorem in section \ref{}.
