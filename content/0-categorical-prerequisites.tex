...
\begin{proof}
    ...
    \[\begin{tikzcd}[column sep = normal, row sep = 2.5em]
        ...
        \arrow[from=2-3, to=2-4]
    \end{tikzcd}\]
    The right most square says $g[1] \circ (-f[1]) = 0$, from which we conclude that $g \circ f = 0$, after applying a quasi-inverse of the translation functor, which is an additive equivalence.
\end{proof}
