...
\begin{definition}  
    ...
    \]
    be a sequence of composable morphisms in an abelian category $\A$. We say the sequence is \emph{exact}, if $g \circ f = 0$ and the induced morphism $\im g \to \ker f$ is an isomorphism.
