...
As with the homotopy category of complexes $K(\A)$, we also have the following bounded versions of the derived category $D(\A)$, exhibited as full triangulated subcategories of the unbounded variant $D(\A)$.
