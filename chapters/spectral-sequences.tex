...
\begin{enumerate}[(a)]
    ...
    \]
    and the isomorphism $\alpha^{p,q}_r$ becomes the identity. We then say that the $(p,q)$-term stabilizes after page $r_0$ and we denote $E^{p,q}_{r_0}$ (along with all the subsequent $E^{p,q}_{r}$ for $r \geq r_0$) by $E^{p,q}_\infty$.
